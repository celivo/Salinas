...
URL = 'https://bulletin.ndsu.edu/course-catalog/descriptions/'
...
departments = []
for link in results:
	p =  re.search(r'\/course-catalog\/descriptions\/([^"]+)', str(link))
	if p:
		departments.append("https://bulletin.ndsu.edu" + p.group(0))
	
some_dep = departments[3:8]
filename = "North_Dakota_State_University_Sample.csv"
